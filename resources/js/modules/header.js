...
const header = document.querySelector('.header'); // Cambiato da .c-header a .header
...
const handleHeaderScroll = () => {
    if (!header) return;
    // Aggiunge 'is-scrolled' se si scende oltre i 20px
...
export const initSiteHeader = () => {
    ...
    // 3. Chiudi il menu se l'utente clicca su un link (utile per le ancore o navigazione interna)
    const navLinks = document.querySelectorAll('.nav__link'); // Cambiato da .c-nav__link a .nav__link
